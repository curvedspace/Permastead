...
{
    private static readonly Uri BaseUri = new("avares://Permastead/Styles");
    ...
    private static readonly Styles FluentDark = new()
    {
        new StyleInclude(BaseUri)
        {
            Source = new Uri("avares://Permastead/Themes/FluentDark.axaml")
        }
    };
    ...
    private static readonly Styles FluentLight = new()
    {
        new StyleInclude(BaseUri)
        {
            Source = new Uri("avares://Permastead/Themes/FluentLight.axaml")
        }
    };
