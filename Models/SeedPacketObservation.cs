...
public class SeedPacketObservation
{
    #region Properties
    ...
    public long SeedPacketId { get { return this.SeedPacket?.Id ?? 0; } }
    ...
    public SeedPacketObservation(string comment) : this()
    {
