    ...
    public class ToDoRepository
    {
        ...
        public static List<ToDo> GetUpcomingToDos(string connectionString, long daysInAdvance)
        {
            ...
            using (IDbConnection connection = new NpgsqlConnection(connectionString))
            {
                ...
                {
                    command.CommandText = sql;
                    command.Parameters.Add(new NpgsqlParameter("@startDate", DateTime.Today.AddDays(-1)));
                    command.Parameters.Add(new NpgsqlParameter("@upcomingDate", DateTime.Today.AddDays(daysInAdvance)));
